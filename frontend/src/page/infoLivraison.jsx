          ...
          <div className="p-4 mb-6 text-white">
            <div className="flex justify-between items-center mb-6">
                <div className='flex items-center'>
                  <div>
                    <h2 className="text-2xl font-bold">Livraison n°14</h2>
                  </div>
            ...
            <div className=" p-4 rounded-lg mb-0 border-b-2 border-gray" style={{backgroundColor: "#041122"}}>
              <h3 className="text-lg font-bold border-b-2 py-2 border-gray">Article commander (1)</h3>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className=" p-4 rounded-lg" style={{backgroundColor: "#041122"}}>
                ...
                <p className="text-sm">Numero du voiture: <strong className='ml-4 text-blue-500'>1452FC</strong></p>
                <p className="text-sm">Frais de livrason: <strong className='ml-4 '>30.000 MGA</strong></p>
                <p className="text-sm">Transporteur: <strong className='ml-4 '>Ralay</strong></p>
                <p className="text-sm">Mode de paiement: <strong className='ml-4 '>Mvola</strong></p>
              </div>
