...
const Commande = () => {
  ...
  const commande = [
    ...
    {id: '25', date:'2024-09-15', statut: 'Terminer', totale: '5.500.000 MGA', payement:'Mvola', nom: 'Sitraka', email: 'sitraka@gmail.com', telephone:'0345685471', produits:'link photo'},
    {id: '25', date:'2024-09-15', statut: 'Terminer', totale: '5.500.000 MGA', payement:'Mvola', nom: 'Sitraka', email: 'sitraka@gmail.com', telephone:'0345685471', produits:'link photo'},
    {id: '25', date:'15/09/2024', statut: 'Encours', totale: '5.500.000 MGA', payement:'Mvola', nom: 'Sitraka', email: 'sitraka@gmail.com', telephone:'0345685471', produits:'link photo'},
    {id: '25', date:'2024-09-15', statut: 'Terminer', totale: '5.500.000 MGA', payement:'Mvola', nom: 'Sitraka', email: 'sitraka@gmail.com', telephone:'0345685471', produits:'link photo'},
    {id: '25', date:'2024-09-15', statut: 'Terminer', totale: '5.500.000 MGA', payement:'Mvola', nom: 'Sitraka', email: 'sitraka@gmail.com', telephone:'0345685471', produits:'link photo'},
    {id: '25', date:'2024-09-15', statut: 'Terminer', totale: '5.500.000 MGA', payement:'Mvola', nom: 'Sitraka', email: 'sitraka@gmail.com', telephone:'0345685471', produits:'link photo'},
  ...
  const filteredOrder = commande.filter(commande => {
    ...
    const quantityMatch = selectedQuantity ? 
      (selectedQuantity === "Terminer" ? commande.statut === 'Terminer' :
       selectedQuantity === "Encours" ? commande.statut === 'Encours' :
       selectedQuantity === "En traitement" ? commande.statut === 'En traitemnt' : true) 
      : true;
              ...
              <tbody className="text-white md-6">
                {currentOrders.map((commande, index) => (
                  <tr key={index} className="hover:bg-gray-900 border-b">
                    ...
                    <td className="py-2 px-4">  
                      <span className="text-sm text-gray-500">{commande.produits}</span>
                    </td>
